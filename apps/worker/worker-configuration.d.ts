/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 49721f626df851024cb40514c3a03d34)
...
interface __BaseEnv_Env {
	...
	RAID_ROOM: DurableObjectNamespace<import("./src/index").RaidRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RaidRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BUILD_VERSION" | "RP_NAME" | "EMAIL_FROM" | "EXTRA_ORIGINS">> {}
}
